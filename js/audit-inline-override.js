                                            ...
                                            <section class="audit-people-board">
                                              <div class="audit-board-hero">
                                                <div class="audit-hero-info">
                                                  <div class="audit-section-kicker"><i class="fa-solid fa-chart-line"></i> AuditorÃ­a de personas</div>
                                                  <h3>ReconciliaciÃ³n HC + salidas vs bajas</h3>
                                              ...
                                              <div class="audit-equation-card">
                                                <div class="audit-section-kicker"><i class="fa-solid fa-arrows-split-up-and-left"></i> Puente de reconciliaciÃ³n</div>
                                                <div class="audit-equation-flow">
                                                  <div class="audit-eq-item base">
                                                    <span>HC ${peopleBridge.labels.previous}</span>
                                                    <strong>${c.previousHC}</strong>
                                                  </div>
                                                  <div class="audit-eq-op"><span class="audit-eq-circle">+</span></div>
                                                  <div class="audit-eq-item up">
                                                    <span>Altas ${peopleBridge.labels.current}</span>
                                                    <strong>${c.hires}</strong>
                                                  </div>
                                                  <div class="audit-eq-op"><span class="audit-eq-circle">-</span></div>
                                                  <div class="audit-eq-item down">
                                                    <span>Bajas ${peopleBridge.labels.previous}</span>
                                                    <strong>${c.bajasPrev}</strong>
                                                  </div>
                                                  <div class="audit-eq-op"><span class="audit-eq-circle">-</span></div>
                                                  <div class="audit-eq-item down">
                                                    <span>Bajas ${peopleBridge.labels.current}</span>
                                                    <strong>${c.bajasCurrent}</strong>
                                                  </div>
                                                  <div class="audit-eq-op"><span class="audit-eq-circle">=</span></div>
                                                  <div class="audit-eq-item expected">
                                                    <span>Esperado</span>
                                                    <strong>${c.bridgeExpected}</strong>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div class="audit-conclusion-card ${c.netDiff ? 'has-gap' : 'ok'}">
                                                <div class="audit-conclusion-left">
                                                  <div class="audit-section-kicker"><i class="fa-solid fa-circle-info"></i> ConclusiÃ³n del cuadre</div>
                                                  <h3>${c.netDiff ? `Faltan ${Math.abs(c.netDiff)} personas netas` : 'Cuadre perfectamente cerrado'}</h3>
                                              ...
                                              <div class="audit-balance-grid">
                                                <div class="audit-balance-card danger">
                                                  <div class="audit-balance-head">
                                                    <span>Faltan / desaparecen</span>
                                                    <strong>${c.missing}</strong>
                                                  </div>
                                                  <div class="audit-bar"><i style="width:${Math.round((c.missing / maxIssue) * 100)}%;"></i></div>
                                                  <p><i class="fa-solid fa-triangle-exclamation"></i> <b>${c.disappearedNoBaja}</b> sin baja encontrada y <b>${c.bajaFueraPuente || 0}</b> con baja fuera del puente.</p>
                                                </div>
                                                <div class="audit-balance-card warn">
                                                  <div class="audit-balance-head">
                                                    <span>Sobran / siguen activos</span>
                                                    <strong>${c.extra}</strong>
                                                  </div>
                                                  <div class="audit-bar"><i style="width:${Math.round((c.extra / maxIssue) * 100)}%;"></i></div>
                                                  <p><i class="fa-solid fa-triangle-exclamation"></i> <b>${c.bajaStillActive}</b> tienen baja registrada, pero siguen activos dentro del HC neto.</p>
                                                </div>
                                              </div>

                                              <div id="auditPeopleIssues" class="audit-issue-grid">
                                                <div class="audit-issue-panel danger">
                                                  <div class="audit-panel-title">
                                                    <span>Personas que faltan</span>
                                                    <b>${missingList.length}</b>
                                                  </div>
                                                  <div class="audit-people-list">${rowHtml(missingList)}</div>
                                                </div>
                                                <div class="audit-issue-panel warn">
                                                  <div class="audit-panel-title">
                                                    <span>Personas que sobran</span>
                                                    <b>${extraList.length}</b>
                                                  </div>
